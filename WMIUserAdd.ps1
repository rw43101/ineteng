...
# WMIUserAdd.ps1
# Example: .\WMIUserAdd.ps1 root/cimv2 add vlab\wmiro Enable,RemoteAccess
# Example above assumes domain is vlab and standard wmi user is wmiro
# prerequisites are met prior to running this script
# Prerequisites: https://pitstop.manageengine.com/portal/en/kb/articles/troubleshoot-non-admin-#domain-user-for-wmi-access#2__Settings_GPO
# Another Link: https://support.infrasightlabs.com/help-pages/setting-up-wmi-access-through-ad-gpo/  - The below Script accomplishes steps 3 and beyond since this cannot be accomplished via GPO without a script
